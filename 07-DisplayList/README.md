...
Instrukcje te to zwyczajne wartości 8-bit które w większości przypadków można sumować, np.: wyświetlić linię z danego obszaru pamięci, wybrać tryb graficzny ANTIC, włączyć scroll poziomy i przerwanie DLI będzie sumą wartości:
