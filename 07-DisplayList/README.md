...
* licznik pobieranie rozkazów zmienia tylko dziesięć najmłodszych w związku z tym po przekroczeniu granicy 1 KB pobieranie dalszych rozkazów **DL** jest kontynuowane od początku bloku **1KB**
